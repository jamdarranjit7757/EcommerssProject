...
import com.example.waayu.databinding.FragmentHomeBinding

import com.example.waayu.ui.adapter.*
import com.example.waayu.ui.viewmodel.HomeViewModel
...
class HomeFragment : Fragment() {
    ...
    private fun setObserver() {
        homeViewModel._responseHome.observe(viewLifecycleOwner) {
            ...
            val adapter = HomePageMainAdapter(mList,requireContext())
            ...
            productAdapter = ProductAdapter(requireContext(),mProductList,
                object : ProductClickListener {
                    override fun onAddProductClick(product: Product) {
                        // Delegate the coroutine call to the ViewModel
